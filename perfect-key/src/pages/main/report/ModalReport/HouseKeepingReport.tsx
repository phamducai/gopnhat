...
interface PropsHouseKeepingReportModal {
    isShowModal: boolean;
...
export const HouseKeepingReportModal = ({ setIsShowModal, isShowModal, title, onSubmit, isLoadingPrint }: PropsHouseKeepingReportModal): JSX.Element => {
                                ...
                                <Controller render={(
                                    ...
                                    <Radio.Group
                                        ...
                                        onChange={e => {
                                            ...
                                            }else if(e.target.value === DateTypeStatus.Today){
