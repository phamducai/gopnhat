...
const CModelTracerMessage = ({ title, visible, onCancel, onOk, content, width, style, zIndex, myForm, 
    isLoading = false, disableBtn, disablePrint = true, disableClose}: PropsModal): JSX.Element => {
            ...
            footer={
                <div className="flex justify-between m-auto w-full">
                    <div className="footer-left">
                        <Button disabled={disablePrint} className={`${classes.buttonFooterLeft} ${classes.buttonFooterLeftDisable} flex items-center`}>
...
export default CModelTracerMessage;
